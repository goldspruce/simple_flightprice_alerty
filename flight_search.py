...
TEQUILA_API_KEY = "bzUjEgPuRzahSdidpCtsJYQGFCE8s0Fg"

from flight_data import FlightData

class FlightSearch:

    def get_destination_code(self,city_name):#for non-OOP have to take out self
        ...
        #print(response.json()["locations"][0])
    ...
    def check_flights(self, origin_city_code, destination_city_code, from_time, to_time):
        ...
        #the above didn't work because I had an empty class, I guess you can assign variables to a class like the below
        # flight_data = FlightData()
